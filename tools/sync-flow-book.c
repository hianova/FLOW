...
static const ChapterInfo ALL_CHAPTERS[] = {
    ...
    },
    {
        ...
        "QSBR 透過靜止狀態檢測與 64 位元世代演進，讀取吞吐量高達 356M ops/s（比 pthread_rwlock 快 24.1 倍），指標熱切換延遲小於 1 微秒且保證 0 請求丟失。",
        "QSBR leverages quiescent-state tracking and 64-bit epoch evolution to deliver 356M ops/s read throughput (24.1x faster than rwlocks) with <1us pointer switch and 0 dropped requests."
    },
    {
