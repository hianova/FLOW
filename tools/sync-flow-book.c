...
static const char * const KNOWLEDGE_LINES[] = {
...
#define KNOWLEDGE_LINE_COUNT (sizeof(KNOWLEDGE_LINES) / sizeof(KNOWLEDGE_LINES[0]))
...
int main(int argc, char **argv) {
    ...
    for (size_t i = 0; i < KNOWLEDGE_LINE_COUNT; ++i) {
        fputs(KNOWLEDGE_LINES[i], f);
    }
    fclose(f);
    printf("Successfully synchronized %s (15 chapters, 42 module bindings)\n", out_path);
    return 0;
}
