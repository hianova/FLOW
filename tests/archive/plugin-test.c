...
static const FlowPlugin PLUGIN = {
    ...
    .component_count = 1u,
    .compatible = plugin_compatible,
    .memory_model = plugin_memory,
    .verify = plugin_verify,
    .emit = plugin_emit,
    .oracle = plugin_oracle,
    .preference = NULL,
    .validate_contract = plugin_validate_contract,
    .lower_domain_semantics = NULL,
    .free_domain_semantics = NULL,
    .enumerate_dimensions = plugin_dimensions,
    .evaluate_plan = plugin_evaluate_plan,
    .verify_plan = plugin_verify_plan,
    .benchmark = NULL,
    ...
    .create_unit = NULL,
    .doc_title = NULL,
    .doc_responsibilities = NULL,
    .doc_algorithmic_guarantee = NULL,
    .doc_memory_concurrency_model = NULL,
    .doc_key_apis = NULL,
    .doc_layer = 0,
    .domain_context = NULL
};
...
static const FlowPlugin CUSTOM_TILE_PLUGIN = {
    .name = "custom_tile",
    .version = "1.0",
    .components = CUSTOM_TILE_COMPONENTS,
    .component_count = 2u,
    .compatible = custom_tile_compatible,
    .memory_model = NULL,
    .verify = NULL,
    .emit = custom_tile_emit,
    .oracle = NULL,
    .preference = NULL,
    .validate_contract = custom_tile_validate_contract,
    .lower_domain_semantics = custom_tile_lower_semantics,
    .free_domain_semantics = custom_tile_free_ctx,
    .enumerate_dimensions = custom_tile_dimensions,
    .evaluate_plan = custom_tile_evaluate_plan,
    .verify_plan = custom_tile_verify_plan,
    .benchmark = custom_tile_benchmark,
    .get_mutation_mask = NULL,
    .preference_mask = NULL,
    .contract_mask = NULL,
    .resource_mask = NULL,
