...
int main(void) {
    ...
    {
        FlowHardwiredPolyhedralTemplate *tpl = flow_hardwired_create(2);
        FLOW_ASSERT_TRUE(tpl != NULL);
    ...
    {
        FlowHardwiredPolyhedralTemplate *tpl_a = flow_hardwired_create(2);
        FlowHardwiredPolyhedralTemplate *tpl_b = flow_hardwired_create(2);
        FLOW_ASSERT_TRUE(tpl_a != NULL && tpl_b != NULL);
        ...
        flow_hardwired_destroy(tpl_a);
        flow_hardwired_destroy(tpl_b);
    }
